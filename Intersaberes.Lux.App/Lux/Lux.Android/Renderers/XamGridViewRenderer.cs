...
using XamGridView = Lux.Controls.XamGridView;

[assembly: ExportRenderer(typeof(XamGridView), typeof(Lux.Droid.Renderers.XamGridViewRenderer))]
namespace Lux.Droid.Renderers
{
	public class XamGridViewRenderer : ViewRenderer<XamGridView, AGridView>
    {
        ...
        protected override void OnConfigurationChanged(global::Android.Content.Res.Configuration newConfig)
        {
            ...
            if (newConfig.Orientation != _orientation)
                OnElementChanged(new ElementChangedEventArgs<Lux.Controls.XamGridView>(this.Element, this.Element));
        }
        
        protected override void OnElementChanged(ElementChangedEventArgs<Lux.Controls.XamGridView> e)
        {
